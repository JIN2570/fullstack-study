// count state를 만들고 버튼을 누를때마다 1씩 증가히고 그 결과가 화면에 출력됨
...
let wrongCount = 0;
  ...
  return (
    <>
      ...
      <button onClick={() => { count++; console.log(count);}}>클릭(잘못된 방법 - 값은 변경됨)</button>
      ...
      <p style={{color: color}}>현재 글자색: 'blue'</p>
